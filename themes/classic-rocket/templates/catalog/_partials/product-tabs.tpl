        ...
        <div class="tab-content" id="tab-content">
            <div class="tab-pane fade{if $product.description} show active{/if}" id="description" role="tabpanel">
                {block name='product_description'}
                    <iframe width="100%" height="300" src="https://www.youtube.com/embed/v865mHIz1g4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
